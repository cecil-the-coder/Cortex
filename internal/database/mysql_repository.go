...
// Implement remaining ConfigRepository methods for MySQL
func (m *MySQLDatabase) CreateProvider(ctx context.Context, provider *Provider) error {
	baseRepo := NewBaseRepository(m.db, m.logger, "mysql")
	return baseRepo.CreateProvider(ctx, provider)
}

func (m *MySQLDatabase) GetProvider(ctx context.Context, id int64) (*Provider, error) {
	baseRepo := NewBaseRepository(m.db, m.logger, "mysql")
	return baseRepo.GetProvider(ctx, id)
}

func (m *MySQLDatabase) GetProviderByName(ctx context.Context, name string) (*Provider, error) {
	baseRepo := NewBaseRepository(m.db, m.logger, "mysql")
	return baseRepo.GetProviderByName(ctx, name)
}

func (m *MySQLDatabase) UpdateProvider(ctx context.Context, provider *Provider) error {
	baseRepo := NewBaseRepository(m.db, m.logger, "mysql")
	return baseRepo.UpdateProvider(ctx, provider)
}

func (m *MySQLDatabase) DeleteProvider(ctx context.Context, id int64) error {
	baseRepo := NewBaseRepository(m.db, m.logger, "mysql")
	return baseRepo.DeleteProvider(ctx, id)
}

func (m *MySQLDatabase) ListProviders(ctx context.Context, filter *ProviderFilter) ([]*Provider, error) {
	baseRepo := NewBaseRepository(m.db, m.logger, "mysql")
	return baseRepo.ListProviders(ctx, filter)
}

func (m *MySQLDatabase) CreateModel(ctx context.Context, model *Model) error {
	query := `
...
func (m *MySQLDatabase) GetModel(ctx context.Context, id int64) (*Model, error) {
	query := `
...
func (m *MySQLDatabase) GetModelByName(ctx context.Context, providerID int64, modelName string) (*Model, error) {
	query := `
		SELECT id, provider_id, model_name, display_name, max_context_tokens,
			supports_vision, supports_tools, input_cost_per_1k, output_cost_per_1k,
			enabled, created_at, updated_at
	...
	err := m.db.QueryRowContext(ctx, query, providerID, modelName).Scan(
		&model.ID,
		&model.ProviderID,
		&model.ModelName,
		&displayName,
...
func (m *MySQLDatabase) UpdateModel(ctx context.Context, model *Model) error {
	query := `
		UPDATE models
...
func (m *MySQLDatabase) DeleteModel(ctx context.Context, id int64) error {
...
func (m *MySQLDatabase) ListModels(ctx context.Context, filter *ModelFilter) ([]*Model, error) {
	query := `
		SELECT id, provider_id, model_name, display_name, max_context_tokens,
			supports_vision, supports_tools, input_cost_per_1k, output_cost_per_1k,
			enabled, created_at, updated_at
	...
	if filter.ProviderID != nil {
		query += fmt.Sprintf(" AND provider_id = ?")
		args = append(args, *filter.ProviderID)
	}

	if filter.ModelName != "" {
		query += fmt.Sprintf(" AND model_name LIKE ?")
		args = append(args, "%"+filter.ModelName+"%")
	}

	if filter.Enabled != nil {
		query += fmt.Sprintf(" AND enabled = ?")
...
func (m *MySQLDatabase) StoreRequestMetrics(ctx context.Context, metrics *RequestMetrics) error {
	baseRepo := NewBaseRepository(m.db, m.logger, "mysql")
	return baseRepo.StoreRequestMetrics(ctx, metrics)
}

func (m *MySQLDatabase) StoreBatchRequestMetrics(ctx context.Context, metrics []*RequestMetrics) error {
	baseRepo := NewBaseRepository(m.db, m.logger, "mysql")
	return baseRepo.StoreBatchRequestMetrics(ctx, metrics)
}

func (m *MySQLDatabase) GetRequestMetrics(ctx context.Context, query *MetricsQuery) ([]*RequestMetrics, error) {
	baseRepo := NewBaseRepository(m.db, m.logger, "mysql")
	return baseRepo.GetRequestMetrics(ctx, query)
}

func (m *MySQLDatabase) GetAggregatedMetrics(ctx context.Context, query *AggregatedQuery) ([]*AggregatedMetrics, error) {
	// MySQL-specific aggregation implementation
	var sqlQuery string
	var args []interface{}
	...
	case "hour":
		sqlQuery = `
			SELECT DATE_FORMAT(timestamp, '%Y-%m-%d %H:00:00') as time_bucket,
				COUNT(*) as count,
...
func (m *MySQLDatabase) CleanupOldMetrics(ctx context.Context, olderThan time.Time) error {
	baseRepo := NewBaseRepository(m.db, m.logger, "mysql")
	return baseRepo.CleanupOldMetrics(ctx, olderThan)
}

func (m *MySQLDatabase) GetMetricsRetention(ctx context.Context) (time.Duration, error) {
	baseRepo := NewBaseRepository(m.db, m.logger, "mysql")
	return baseRepo.GetMetricsRetention(ctx)
}

func (m *MySQLDatabase) GetProviderHealthStats(ctx context.Context, providerID int64, timeRange TimeRange) (map[string]interface{}, error) {
	baseRepo := NewBaseRepository(m.db, m.logger, "mysql")
	return baseRepo.GetProviderHealthStats(ctx, providerID, timeRange)
}

func (m *MySQLDatabase) GetSystemMetrics(ctx context.Context, timeRange TimeRange) (map[string]interface{}, error) {
	baseRepo := NewBaseRepository(m.db, m.logger, "mysql")
	return baseRepo.GetSystemMetrics(ctx, timeRange)
}

// Additional MetricsRepository methods
func (m *MySQLDatabase) BatchRecordRequests(ctx context.Context, metrics []*RequestMetrics) error {
	baseRepo := NewBaseRepository(m.db, m.logger, "mysql")
	return baseRepo.BatchRecordRequests(ctx, metrics)
}

func (m *MySQLDatabase) RecordProviderHealth(ctx context.Context, health interface{}) error {
	baseRepo := NewBaseRepository(m.db, m.logger, "mysql")
	return baseRepo.RecordProviderHealth(ctx, health)
}

func (m *MySQLDatabase) AggregateMetrics(ctx context.Context) error {
	baseRepo := NewBaseRepository(m.db, m.logger, "mysql")
	return baseRepo.AggregateMetrics(ctx)
}

// Remaining ConfigRepository methods (similar to SQLite implementation)
func (m *MySQLDatabase) CreateModelGroup(ctx context.Context, group *ModelGroup) error {
	query := `
...
func (m *MySQLDatabase) GetModelGroup(ctx context.Context, id int64) (*ModelGroup, error) {
	query := `
...
func (m *MySQLDatabase) GetModelGroupByName(ctx context.Context, name string) (*ModelGroup, error) {
	query := `
		SELECT id, name, description, created_at, updated_at
		FROM model_groups
		WHERE name = ?
...
func (m *MySQLDatabase) UpdateModelGroup(ctx context.Context, group *ModelGroup) error {
	query := `
		UPDATE model_groups
...
func (m *MySQLDatabase) DeleteModelGroup(ctx context.Context, id int64) error {
...
func (m *MySQLDatabase) ListModelGroups(ctx context.Context) ([]*ModelGroup, error) {
	query := `
		SELECT id, name, description, created_at, updated_at
		FROM model_groups
		ORDER BY name
...
func (m *MySQLDatabase) AddGroupMember(ctx context.Context, member *GroupMember) error {
	query := `
...
func (m *MySQLDatabase) RemoveGroupMember(ctx context.Context, id int64) error {
...
func (m *MySQLDatabase) GetGroupMembers(ctx context.Context, groupID int64) ([]*GroupMember, error) {
	query := `
...
func (m *MySQLDatabase) CreateAPIKey(ctx context.Context, apiKey *ClientAPIKey) error {
	return fmt.Errorf("API key management not implemented yet")
}

func (m *MySQLDatabase) GetAPIKey(ctx context.Context, id int64) (*ClientAPIKey, error) {
	return nil, fmt.Errorf("API key management not implemented yet")
}

func (m *MySQLDatabase) GetAPIKeyByKeyID(ctx context.Context, keyID string) (*ClientAPIKey, error) {
	return nil, fmt.Errorf("API key management not implemented yet")
}

func (m *MySQLDatabase) UpdateAPIKey(ctx context.Context, apiKey *ClientAPIKey) error {
	return fmt.Errorf("API key management not implemented yet")
}

func (m *MySQLDatabase) DeleteAPIKey(ctx context.Context, id int64) error {
	return fmt.Errorf("API key management not implemented yet")
}

func (m *MySQLDatabase) ListAPIKeys(ctx context.Context, filter *APIKeyFilter) ([]*ClientAPIKey, error) {
	return nil, fmt.Errorf("API key management not implemented yet")
}

func (m *MySQLDatabase) GetRouterConfig(ctx context.Context) (*RouterConfig, error) {
	return nil, fmt.Errorf("Router configuration management not implemented yet")
}

func (m *MySQLDatabase) UpdateRouterConfig(ctx context.Context, config *RouterConfig) error {
	return fmt.Errorf("Router configuration management not implemented yet")
}

func (m *MySQLDatabase) ExportConfig(ctx context.Context) (*config.Config, error) {
	return nil, fmt.Errorf("Configuration export not implemented yet")
}

func (m *MySQLDatabase) ImportConfig(ctx context.Context, cfg *config.Config) error {
